...
# $Selection = Create-Menu -MenuTitle "Sup?  This is a menu.  Pick a choice?" -MenuOptions "Option1","opt2","choice3" -Columns 1 -ShowCurrentSelection $true

# switch ($Selection) {
#     0 {Write-Host "You chose Option1!"  }
#     1 {Write-Host "You chose opt2!"  }
#     2 {Write-Host "You chose choice3!"  }
#     Default {}
# }